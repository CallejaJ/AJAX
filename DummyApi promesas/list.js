function inicializar2(){
    ...
    const otraPromesa = fetch("https://dummyapi.io/data/v1/user?limit=10"){
        app-id = "6470cb07b1bb3876c0d9c81c"
    };
...
.then((response) => {
    ...
    Paginas(response)
    } // para que me de la respuesta por consola 
...
function ListaUsuarios(listaUsuarios){
    ...
    this.render = function(){
        ...
        paginacionDiv.innerHTML += `<a href="#" onclick="userList(${i})">${i}</a>, `;
        }
    }
